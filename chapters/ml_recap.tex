...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{media/ml_recap/deep_clustering.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{media/ml_recap/deep_generative_models.png}
...
To avoid overfitting, we can simply use a simpler model, reduce its capacity or we can use regularization techniques.
