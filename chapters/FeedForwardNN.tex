...
During testing, the running avareges of $\mu$ and $\sigma$ are collected during training and used to normalize the inputs, instead of computing the mean and standard deviation from the mini-batch of test data.
