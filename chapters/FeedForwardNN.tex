...
\begin{figure}[H]
    \centering
    \scalebox{0.3}{\input{Tikz/FFNN/optimization/BGD-SGD-Momentum.tex}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.7}{\input{Tikz/FFNN/optimization/momentum-methods.tex}}
    \caption{Different optimization algorithms.}
\end{figure}
...
As you might have experienced, with FFNNs, overfitting is a common problem that needs to be addressed. 
