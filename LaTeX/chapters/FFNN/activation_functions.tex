...
\begin{figure}[H]
    \centering
    \input{LaTeX/Tikz/FFNN/activation_functions/sigmoid.tex}
\end{figure}
...
\begin{figure}[H]
    \centering
    \input{LaTeX/Tikz/FFNN/activation_functions/hyperbolic_tangent.tex}
\end{figure}
...
\begin{figure}[H]
    \centering
    \input{LaTeX/Tikz/FFNN/activation_functions/relu.tex}
\end{figure}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \input{LaTeX/Tikz/FFNN/activation_functions/leaky_relu.tex}
        \end{figure}
