\begin{tikzpicture}[
  ...
  % Hidden layer 1 (top node in focus)
  \foreach \j/\y in {1/1.8,2/0.6,3/-0.6,4/-1.8} {
    \node[faded_neuron] (h1\j) at (3.0, \y) {};
  }
  \node[focus_neuron] (h11f) at (3.0, 1.8) {};

  % Hidden layer 2 (bottom node in focus)
  \foreach \j/\y in {1/0.6,2/-0.6} {
    \node[faded_neuron] (h2\j) at (6.0, \y) {};
  }
  \node[focus_neuron] (h22f) at (6.0, -0.6) {};
  ...
  % Highlighted used weights / path
  \draw[conn_weight] (h11) -- (h22);
  \foreach \j in {1,...,3} {
    \draw[conn_active] (h22) -- (h3\j);
  }
  \foreach \i in {1,...,3} {
    \foreach \k in {1,2} {
